...
{
    public class tbCustomerController : ApiController
    {
        #region 用户表

        #region 声明变量
        Maticsoft.BLL.tbCustomer BLL = new Maticsoft.BLL.tbCustomer();
        ...
        [HttpGet]
        [HttpPost]
        public HttpResponseMessage Save(Maticsoft.Model.tbCustomer info)
        {
            HttpResponseMessage result;
            ...
            try
            {
                ...
                {
                    Maticsoft.Model.tbCustomer info1 = (Maticsoft.Model.tbCustomer)BLL.GetModel(info.id);
